...
class RideEventViewSetTestCase(APITestCase):
    ...
    def test_admin_can_retrieve_ride_event(self):
        self.client.force_login(self.admin_user)
        response = self.client.get(reverse('rideevent-detail', args=[self.ride_event.id]))
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_admin_can_update_ride_event(self):
        ...
        response = self.client.put(reverse('rideevent-detail', args=[self.ride_event.id]), data)
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_admin_can_delete_ride_event(self):
        self.client.force_login(self.admin_user)
        response = self.client.delete(reverse('rideevent-detail', args=[self.ride_event.id]))
