...
class UserViewsTestCase(TestCase):
    def setUp(self):
        ...
        self.non_admin_user = User.objects.create(username='non_admin_user', email='non_admin_user@example.com')
    ...
    def test_admin_can_update_user(self):
        ...
        response = self.client.put(reverse('user-detail', args=[self.non_admin_user.id]), data)
        self.assertEqual(response.status_code, status.HTTP_200_OK)
